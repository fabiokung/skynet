...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!                                                                        !!!!
!!!!  THIS PROGRAM NEEDS TO BE DELETED, BECAUSE OTHERWISE IT WILL CREATE A  !!!!
!!!!  MAIN FUNCTION IN THE C++ LIBRARY THAT WOULD PREVENT THIS CODE FROM    !!!!
!!!!  BEING USED IN A C++ EXECUTABLE. (Jonas Lippuner, 2014-08-06)          !!!!
!!!!                                                                        !!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
! routine helmeos_orig as helmeos with the table read inside the routine
      ...
      subroutine read_helm_table(helm_table_path)
      include 'implno.dek'
...
! declare local variables
      character(*), intent(in) :: helm_table_path
      integer          i,j
...
! this produces a floating-point exception in some rare cases
